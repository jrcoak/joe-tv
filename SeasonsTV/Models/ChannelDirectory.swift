...
enum ChannelDirectory {
    static let channels: [CuratedChannelDefinition] = [
        ...
        .init(displayName: "NHPBS", playbackIdentity: "nhpbs:main", stationID: "25002", callSign: "WENHDT"),
        .init(displayName: "NHPBS Explore", playbackIdentity: "nhpbs:explore", stationID: "58447", callSign: "WENHDT2"),
        .init(displayName: "NHPBS World", playbackIdentity: "nhpbs:world", stationID: "63377", callSign: "WENHDT3"),
        .init(displayName: "PBS Kids", playbackIdentity: "nhpbs:kids", stationID: "107749", callSign: "WENHDT5"),
